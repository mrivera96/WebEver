...
<div class="container">
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading " style="height: 40px">
          ...
          <h3 class="panel-title"><span class="glyphicon glyphicon-pencil"></span><strong>   Edición de Perfil</strong></h3>
        </div>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" id="eliminar" class="btn btn-primary" onClick="javascript:(function(){window.location.href = 'contactosAprobadosCliente';})()">Sí, borrar</button>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-primary" onClick="javascript:(function () {
                        window.location.href = 'contactosAprobadosCliente';
                      })()">Aceptar</button>
  ...
  <br>
    ...
    <script type="text/javascript" src="js/ediciondeperfilusuarionormal.js"></script>
