  ...
  <link href="css/estilos_melvin.css" rel="stylesheet">
        ...
        <div id="encabezado_contactos_activos" class="container">
          <div class="col-md-9 col-sm-9 col-xs-9">
            <h4 style="color: white"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Lista de Contactos Pendientes</h4>
          </div>
...
<script type="text/javascript">
    var id_logueado=<?php echo $_SESSION['idUrs']; ?>;
        ...
        <script type="text/javascript" src="js/contactosusuariospendientes.js"></script>
